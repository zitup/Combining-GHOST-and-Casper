...
在一个协议中，如果验证者遵守协议，则称其为*诚实的*，否则为拜占庭式的。我们通常假设严格少于 _p = 1/3_ 的验证者是拜占庭式的。这个常数可以追溯到实用拜占庭容错（Practical Byzantine Fault Tolerance (PBFT) ）[[8](#8)]，这是拜占庭容错⽂献中的经典共识协议；PBFT 确保只要少于 1/3 的副本（与我们的验证者同义）是拜占庭的，系统就能正常运⾏，如 [[3](#3)] 中证明的那样。这个常数 1/3 容错率经常出现在许多基于 PBFT 的作品中（主要思想是鸽巢原理论证需要 1/3 才能起作⽤，例如我们在第 5 节中的证明），其中 Casper FFG [[7](#7)] 与我们的⼯作最直接相关，我们将在第 3.1 节中对其进⾏回顾。
